...
if (process.env.ENVIRONMENT === 'production') {
  resourcesConstants = {
    API_URL: '',
    IFRAME_URL: process.env.WIDGET_URL || 'https://widget.teleflow.khulnasoft.com',
    WWW_URL: process.env.WIDGET_URL || 'https://widget.teleflow.khulnasoft.com',
    SENTRY_DSN: 'https://bcadda4b593d454797a1260e094f0c5d@o1161119.ingest.sentry.io/6252448',
  };
} else if (process.env.ENVIRONMENT === 'dev') {
  resourcesConstants = {
    API_URL: '',
    IFRAME_URL: process.env.WIDGET_URL || 'https://dev.widget.teleflow.khulnasoft.com',
